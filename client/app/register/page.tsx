        ...
        <div className="max-w-md mx-auto mt-16 px-4">
            <div className="premium-card p-8 sm:p-10 bg-white">
                <div className="text-center mb-10">
                    ...
                    <p className="text-slate-500 mt-2">Join Item Manager today</p>
                </div>

                {error && (
                    <div className="bg-red-50 border border-red-200 text-red-700 rounded-xl p-4 text-sm mb-8 animate-shake flex items-center gap-3">
                ...
                <div className="mt-10 pt-8 border-t border-slate-100 text-center">
                    <p className="text-sm text-slate-500">
                        ...
                        <Link href="/login" className="text-indigo-600 hover:text-indigo-700 font-bold tracking-tight">
                            Login here
                        </Link>
                    </p>
                </div>
